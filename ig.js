...
$(function (){
    // get instagram.json
    $.get("https://www.instagram.com/explore/tags/555/?__a=1", function(data, status){
        console.log(status);
    ...
    $("#search").click(function(){
        var KeywordSeartch = $("#KeywordSeartch").val();
        Igsearch(KeywordSeartch);
        
       });
function  Igsearch(KeywordSeartch){
    $("#posts").empty();

    
    // get instagram.json
    $.get(`https://www.instagram.com/explore/tags/${KeywordSeartch}/?__a=1`, function(data, status){
        console.log(status);
